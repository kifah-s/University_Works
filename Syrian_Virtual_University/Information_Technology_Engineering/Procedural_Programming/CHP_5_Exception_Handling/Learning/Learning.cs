...
//* Exe - 3 - (Version 2): Write a program to calculate a student's grade point average in ten subjects so that it does not accept negative grade values.
/*
//* Functions ..
static void negativeMark(double m)
{
    if (m < 0)
    {
        throw new Exception("Mark must be positive");
